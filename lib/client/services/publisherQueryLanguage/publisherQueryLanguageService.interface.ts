...
/**
 * Provides methods for executing a PQL {@link https://developers.google.com/ad-manager/api/reference/v202405/PublisherQueryLanguageService.Statement Statement}
 * to retrieve information from the system. In order to support the selection of columns of interest from various tables,
 * {@link https://developers.google.com/ad-manager/api/reference/v202405/PublisherQueryLanguageService.Statement Statement} objects support a "select" clause.
 *
...
export interface PublisherQueryLanguageServiceOperations {
   ...
   * {@link https://developers.google.com/ad-manager/api/reference/v202405/PublisherQueryLanguageService.Statement#query Statement.query} from the system.
   *
